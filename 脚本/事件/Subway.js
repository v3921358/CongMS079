...
function scheduleNew() {
    ...
    KC_docked.broadcastMessage(MaplePacketCreator.serverNotice(6, "地铁列车到站了。"));
    NLC_docked.broadcastMessage(MaplePacketCreator.serverNotice(6, "地铁列车到站了。"));
...
function takeoff() {
    ...
    KC_docked.broadcastMessage(MaplePacketCreator.serverNotice(6, "地铁列车已经离开了."));
    NLC_docked.broadcastMessage(MaplePacketCreator.serverNotice(6, "地铁列车已经离开了."));
