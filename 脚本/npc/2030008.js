...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.getPlayerStat("LVL") >= 50) {
			var nownumber=2;
			nownumber=nownumber-cm.getBossLog("进阶扎昆");
		...
		{
			if (cm.getMap(910000022).getCharactersSize() > 0  ) {
                cm.sendOk("其它队伍，正在挑战中。");	
                cm.dispose();
				return;
            }
			if(cm.getLevel()>149&&cm.getBossLog("进阶扎昆")<=2){
			if(cm.haveItem(4001017,5)){
				cm.gainItem(4001017,-5);
				cm.setBossLog("进阶扎昆");
				cm.getMap(910000022).resetFully();
				cm.spawnMobOnMap(8800102,1,679,94,910000022);
				cm.spawnMobOnMap(8800103,1,679,94,910000022);
				cm.spawnMobOnMap(8800104,1,679,94,910000022);
				cm.spawnMobOnMap(8800105,1,679,94,910000022);
				cm.spawnMobOnMap(8800106,1,679,94,910000022);
				cm.spawnMobOnMap(8800107,1,679,94,910000022);
				cm.spawnMobOnMap(8800108,1,679,94,910000022);
				cm.spawnMobOnMap(8800109,1,679,94,910000022);
				cm.spawnMobOnMap(8800110,1,679,94,910000022);
				cm.spawnMobOnMap(8800100,1,679,94,910000022);
				cm.warp(910000022, 0);
				cm.dispose();
			    return;
			}else
			{
				cm.sendOk("需要物品[#v4001017##r#c4001017##k/5]!");
				cm.dispose();
			}
			}
			else
			{
				cm.sendOk("您当前等级没有达到150级,或每天挑战次数达到限制!");
				cm.dispose();
			}
		}
    } else if (status == 2) {
