var rewards = Array(2210019, 2022154, 2100003, 2100006, 2101001, 2022245, 2049601);//物品代码
var quantity = Array(1, 1, 1, 1, 1, 1, 1);//兑换物品数量
var needed = Array(1, 5, 10, 15, 20, 20, 40);//需要物品兑换数量
