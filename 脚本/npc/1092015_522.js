...
var status = 0;
	...
	if (status == 0) {
		...
		textz += "#b#L1#游戏币觉醒时装 #rx"+金币+"/次 2 全属性\r\n";

		textz += "#b#L2#点券觉醒时装 #rx"+点券+"/次 随机全属性 1-5 \r\n";
		
		textz += "#b#L3##z"+道具+"#觉醒时装 #rx"+签到+"/次 随机全属性 1-8 \r\n";
		
		textz += "#L4#充值币神级觉醒（土豪必备） #rx"+充值币+"/次，神级全属性20-攻魔10 血量 200  \r\n";
		...
		cm.sendSimple (textz);  
                   ...
                   if (selection == 0) {
                      var selStr = "当玩家的等级达到#e#r120#k#n级时，可以使用时装觉醒系统，时装觉醒系统能够为你的点状增加一定的#b力量，敏捷，治理，运气#k，目前可以使用游戏币，点券，出席图章激活点状，没中觉醒的方式带来的能力效果都不同。\r\n";
						  ...
						  selStr += " 使用#b充值币#k则能够随机波动#r5-10#k点，并有30%几率产生四维属性+20以及 双攻+10 血量 200 的#r审计觉醒#k\r\n\r\n";
