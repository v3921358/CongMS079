...
function start() {
    ...
    if (mapid == 925020001) {
        cm.sendSimple("我们主人是武陵道场的师傅。你想要挑战我们师傅？不要说我沒提醒你他是最牛逼的。 \r #b#L0#我要单人挑战#l \n\r #L1#我要组队进入#l \n\r #L2#我要兑换腰带#l \n\r #L3#我要重置我的点数#l \n\r #L5#什么是武陵道场?#l");
    } else if (isRestingSpot(mapid)) {
        cm.sendSimple("我很惊讶，您已经安全的达到这里了，我可以向你保证，它沒有这么容易过关的，你想要坚持下去？#b \n\r #L0#是，我想继续。#l \n\r #L1# 我想离开#l \n\r #L2# 我想要保存这一次的记录下一次用。#l");
    } else {
        cm.sendYesNo("你想要离开了？我可以给你一脚，踹你出去。");
    }
}
...
function action(mode, type, selection) {
    if (mapid == 925020001) {
        ...
        if (status == 0) {
            ...
            if (sel == 5) {
                cm.sendNext("#b[武陵道场]#k #e#r殴打你的地方#k!");
                cm.dispose();
            } else if (sel == 3) {
                cm.sendYesNo("你是真的要重置！？ \r\n別怪我沒警告你。");
            } else if (sel == 2) {
                cm.sendSimple("现在你的道场点数有 #b" + cm.getDojoPoints() + "#k. 我們的主人喜欢有才华的人，所以如果你有了足够的道场点数，你就可以根据你的道场点数依序换取腰帶...\n\r #L0##i1132000:# #t1132000#(200)#l \n\r #L1##i1132001:# #t1132001#(1800)#l \n\r #L2##i1132002:# #t1132002#(4000)#l \n\r #L3##i1132003:# #t1132003#(9200)#l \n\r #L4##i1132004:# #t1132004#(17000)#l");
            } else if (sel == 1) {
                if (cm.getParty() != null) {
                    if (cm.isLeader()) {
                        cm.sendOk("走咯。");
                    } else {
                        cm.sendOk("你丫的，队员就不要凑热闹，叫你的队长來跟我谈。");
                    }
                } else {
                    cm.sendOk("小朋友，你好像没有组队哦。");
                    cm.dispose();
                    return;
                }
            } else if (sel == 0) {
            ...
            if (sel == 3) {
                ...
                if (record == selection && cm.getDojoPoints() >= required) {
                    ...
                    cm.sendOk("请依照順序兑换腰帶！谢谢");
                } else {
                    cm.sendOk("你好像沒有足夠的道场点数可以换....");
                }
                cm.dispose();
            } else if (sel == 1) {
        ...
        if (status == 0) {
            ...
            if (sel == 0) {
                ...
                if (cm.getParty() == null) {
                    ...
                    cm.sendOk("我刚刚保存你这次的记录，下次当你返回我就直接送你到这里。");
                    cm.dispose();
                } else {
                    cm.sendOk("嘿，小傢伙你不能保存..因为这是组队挑战！");
                    cm.dispose();
                }
            }
        } else if (status == 1) {
