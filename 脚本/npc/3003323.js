...
//------------------------------------------------------------------------
            ...
            if (selection == 2) {
				cm.dispose();
				cm.openNpc(3003323, "坐骑升星");
        }		
		    if (selection == 3) {
				cm.dispose();
				cm.openNpc(3003323, "时装点卷强化");
        }	 if (selection == 4) {
				cm.dispose();
				cm.openNpc(3003323, "时装强化卷轴");
        }	if (selection == 5) {
				cm.dispose();
				cm.openNpc(3003323, "勋章点卷强化");
        }	if (selection == 6) {
				cm.dispose();
				cm.openNpc(3003323, "点卷神级强化");
        }		
