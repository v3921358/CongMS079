...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.GetPiot("名人榜开关", "1") <= 0) {
			...
			selStr += "#L21##b"+皇冠+"五子棋积分排行"+皇冠+"#l\r\n";
			//selStr += "#L6##b"+皇冠+"玩家满级排行榜"+皇冠+"#l\r\n";
			
            //selStr += "#L2##b"+皇冠+"玩家财富排行榜"+皇冠+"#l";
            selStr += "#L13##b"+皇冠+"在线时常排行榜"+皇冠+"#l";
			//selStr += "\t\t\t\t#L4##b重生永恒排行榜#l\r\n";
			selStr += "#L0##b"+皇冠+"家族总GP排行榜"+皇冠+"#l\r\n";
			selStr += "#L19##b"+皇冠+"人气明星排行榜"+皇冠+"#l";
            selStr += "#L78##b"+皇冠+"家族任务排行榜"+皇冠+"#l\r\n";
			selStr += "#L80##b"+皇冠+"全服战力排行榜"+皇冠+"#l";
			selStr += "#L81##b"+皇冠+"职业战力排行榜"+皇冠+"#l\r\n\r\n";
			selStr += "#L79##b"+皇冠+"家族周GP排行榜"+皇冠+"#l\r\n\r\n";
        ...
        switch (selection) {
			...
			case 78:
                cm.dispose();
				cm.openNpc(9040004, "家族任务排名");
                break;
			case 79:
                cm.dispose();
				cm.openNpc(9040008, 0);
                break;
			case 80:
                cm.dispose();
				cm.openNpc(9040008, "全服战力排行榜");
                break;
			case 81:
                cm.dispose();
				cm.openNpc(9040008, "职业战力排行");
                break;
        }
    }
}
