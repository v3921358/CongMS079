...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "#L0##b" + 蓝色箭头 + "英语组队副本(0-250)#l   #L4##b" + 蓝色箭头 + "天空组队副本(50-250)#l\r\n\r\n"
            text += "#L1##b" + 蓝色箭头 + "月妙组队副本(10-250)#l  #L5##b" + 蓝色箭头 + "毒物组队副本(70-250)#l\r\n\r\n"
            
            text += "#L2##b" + 蓝色箭头 + "废弃组队副本(15-250)#l  #L6##b" + 蓝色箭头 + "海盗组队副本(80-250)#l\r\n\r\n"
			
			text += "#L3##b" + 蓝色箭头 + "玩具组队副本(35-250)#l\r\n\r\n"
            //text += "#L7##b" + 红色箭头 + "男女组队副本 (71-256)  \r\n"
     
            text += ""+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+"\r\n"  
            //text += "#L27##b"+红色箭头+ "二十七宫#l \r\n"//3 
			text += "#L38##b" + 红色箭头 + "武陵道场 (武林状元)\r\n"
			text += "#L8##b" + 红色箭头 + "遗址公会对抗战(家族副本)#l\r\n"
			text += "#L10##b" + 红色箭头 + "怪物嘉年华 (组队对抗副本.最低2V2)等级(30-100)#l\r\n\r\n"
			text += ""+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+"\r\n"  
