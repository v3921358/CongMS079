...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (section == 0) {
            ...
            cm.sendNext("更好的建設村落是村长的职责。所以需要更多更好的道具。你能为了村落捐献出在神木村附近收集到的道具吗？");
		} else if (section == 2) {
        ...
        if (section == 0) {
			...
			if (cm.haveItem(4031348)) {
				status = 3;
				cm.sendNext("你已经有了#t4031348#，那么現在我要用我的神奇魔法把#t4031348#变成四转所需的道具。");
			} else {
        ...
        if (section == 0) {
            ...
            if (cm.haveItem(itemID[temp])) {
                ...
                cm.sendGetNumber("你要捐多少个 #b#t" + itemID[temp] + "#k'我会給你很好的酬劳的！", 1, 1, 999);
            } else {
