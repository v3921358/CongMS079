...
function action(mode, type, selection) {
    if (mode == 1)
        ...
        cm.dispose();
    if (status == 0 && mode == 1) {
        var selStr = "哈囉，我是比休斯，退休的狙击手，但我曾经是雅典娜皮尔斯顶尖的学生，我不再打猎了，但我可以帮你製作一些对你有帮助的物品#b"
        var options = new Array("製作弓", "製作弩", "製作手套", "升级手套", "木材与螺丝钉製作", "製作箭矢");
        ...
        if (selectedType == 0) { //bow refine
            ...
            var materials = new Array("用10个树枝製作1个木材", "用5个木柴製作1个木材", "製作螺丝钉(1次15个)");
            ...
            var arrows = new Array("製作箭矢", "製作弩箭矢", "製作青铜弓箭", "製作青铜弩箭", "製作钢铁弓箭", "製作钢铁弩箭");
