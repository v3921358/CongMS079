			...
			if (preamble == null) {
				...
				if (complete != null) {
					...
					if (!cm.haveItem(4001008, numpasses)) {
						...
						clear(1,eim,cm);
						cm.givePartyExp(cm.getLevel()*500, party);
...
if (playerStatus){
	...
	Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(3, cm.getClient().getChannel(), "『组队任务 - 废弃副本』" + " : " + "[" + cm.getChar().getName() + "]成功通关废弃副本 获得超级丰富的奖励！！")); 
