...
function action(mode, type, selection) {
	...
	if (selection == 0) {
		...
		hair_Colo_new = [31150, 31310, 31300, 31160, 31100, 31410, 31030, 31080, 31070, 31610, 31350, 31510];
	    }
	    for (var i = 0; i < hair_Colo_new.length; i++) {
		hair_Colo_new[i] = hair_Colo_new[i] + (hair % 10);
	    }
	    cm.sendYesNo("是否要使用 #b#t5150008##k 來随机抽取？？");
	    ...
	    cm.sendYesNo("是否要使用 #b#t5151008##k 來随机抽取？？");
	}
    } else if (status == 2){
	if (beauty == 1){
