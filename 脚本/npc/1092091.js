...
var chance4 = Math.floor(Math.random() * 100 + 100);//点卷随机变量 *20为每次最小数字20 +10是浮动数字 最大为30 可以自行设定大小
...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        case 1:
            ...
            cm.sendOk("         #r活动将在20点30分-35分开始#n\r\n\r\n#b开启活动后请疯狂点击奶牛。这样您将随机获得一些点卷，抵用卷，金币的奖励。#k");
            cm.dispose();
            break;
        case 2:
            if ( ( weekday == 2 &&hour == 20 && minute >= 30 && minute <= 35 ) ) {//开启时间每小时23-24分钟之间
