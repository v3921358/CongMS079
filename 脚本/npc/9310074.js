...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		selStr += "#L1##e#r"+大水滴+"[周一]疯狂牛奶活动#d(金币 经验 抵用卷 点卷)#l\r\n";
		selStr += "#L2##e#r"+大水滴+"[周二]收集物品活动#d(黄金枫叶 混沌卷 祝福卷)#l\r\n";
		selStr += "#L3##e#r"+大水滴+"[周三]疯狂答题活动#d(金币 点卷 枫叶 黄金枫叶)#l\r\n";
		selStr += "#L4##e#r"+大水滴+"[周四]疯狂跳跳活动#d(技能币 枫叶 黄金枫叶 )#l#k\r\n";
		selStr += "#L5##e#r"+大水滴+"[周五]疯狂赏金活动#d(枫叶 黄金枫叶)#l#k\r\n";
		...
		case 1:
            ...
            break;
        case 2:
           if(cm.getBossLog('周二活动')<1 && weekday == 3 && cm.haveItem(4001128,1000) &&hour == 20 && minute >= 30 && minute <= 40){
			 cm.setBossLog('周二活动');
			 cm.gainItem(4001128,-1000);
		     cm.gainItem(4000313,50);
	         cm.gainItem(2049118,1);//混沌卷
            ...
            cm.sendOk("#r活动在周二开启,20:30-20:40开启,只能做1次,\r\n#d当前服务器时间: #r" + hour + " #b点 #r" + minute + " #b分 \r\n需求;#v4001128#*1000!");
			cm.dispose();
             break;
			}
        case 3:
	    ...
	    //cm.openShop(103);
            break;
        case 4:
            if(weekday == 5 &&hour == 20 && minute >= 30 && minute <= 40){
            ...
            cm.sendOk("#r活动在周四开启,20:30-20:40开启\r\n#d当前服务器时间: #r" + hour + " #b点 #r" + minute + " #b分");
			cm.dispose();
             break;
			}
        case 5:
             cm.dispose();
            cm.openNpc(9900004, 12367);//挤奶活动
            break;
        case 6:
            cm.dispose();
            cm.openNpc(9310074,"吃鸡战场");
            break;
        case 7:
            cm.dispose();
