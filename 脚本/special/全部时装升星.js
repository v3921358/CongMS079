...
//Math.floor(Math.random() * 7 + 1)生成1和7之间的随机整数,注意是整数，不是小数..
var xx;//
var xxdj;//
var sj1;//成功率
		...
		if (status == 0) {
			...
			if(cm.getInventory(1).getItem(1)== null ){
			 ...
			 return;
				...
				sj = Math.floor(Math.random()*99+1);//向下取整，取1-99之间的随机整数
				shibai = 0;
				xxnew = "☆";
				点卷数量 = 1000;
				四维属性 = 1;
				...
				sj = Math.floor(Math.random()*80);//向下取整，取1-79之间的随机整数
				shibai = 0;
				xxnew = "☆☆";
				xxdj = 1;
				点卷数量 = 2000;
