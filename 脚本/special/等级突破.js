...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var selStr = "#d   "+美化1+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+"<<突破极限>>"+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化2+""+美化3+"\r\n\r\n  ";
		
		if (cm.getPlayer().getLevel() < 249 && !cm.getPlayer().isGM()) {
		selStr += "哈喽，人家脸其实也不大啦，记住哦！等您达到满级250级可以来找我哦\r\n\r\n";
		}
		
		
		if (cm.getPlayer().getLevel() > 249 && !cm.getPlayer().isGM()) {
		selStr += "           #k这里可以帮助满级玩家进行突破！\r\n#l";
		selStr += "          #k你当前已经突破#r"+ cm.getOneTimeLog("修仙次数") +"#k次 每次突破换线生效！\r\n\r\n";
		selStr += "                    #L2##b领取奖励#l\r\n";
		selStr += "                    #L3##b突破说明\r\n#l";
		selStr += "              #L1##b我要突破（降级至200级）#l\r\n";
		}
