...
add +=      " #L3##s"+14111000+"##s"+14111000+"##s"+14111000+"##l          #L2##s"+14101004+"##s"+14101004+"##s"+14101004+"##l\r\n\r\n";

add +=      " #L4##s"+2311003+"##s"+2311003+"##s"+2311003+"##l          #L1##s"+12101003+"##s"+12101003+"##s"+12101003+"##l\r\n\r\n";

add +=      " #L5##s"+3121002+"##s"+3121002+"##s"+3121002+"##l          #L6##s"+1121002+"##s"+1121002+"##s"+1121002+"##l\r\n\r\n";
						 
// #L3##s"+14111000+"##s"+14111000+"##s"+14111000+"##l 			 
		add += ""+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+红爱心+"\r\n";
...
//------------------------------------------------------------------------
			...
			if (selection == 3) {//充值
				cm.dispose();
				cm.openNpc(9270048, "分身技能");
        }		
            if (selection == 2) {
				cm.dispose();
				cm.openNpc(9270048, "二段跳");
        }		
		    if (selection == 1) {
				cm.dispose();
				cm.openNpc(9270048, "快速移动");
        }	
            if (selection == 4) {
				cm.dispose();
				cm.openNpc(9270048, "神圣祈祷");
        }	
            if (selection == 5) {
				cm.dispose();
				cm.openNpc(9270048, "火眼");
        }	if (selection == 6) {
				cm.dispose();
				cm.openNpc(9270048, "泰山");
        }			
