...
var 皇冠白 ="#fUI/GuildMark/Mark/Etc/00009004/16#";
	...
	if (selection == 0) {
		...
		cm.gainItem(1302208,60,60,60,60,60,60,60,60,0,0,0,0,0,0,24);//
		...
		//	cm.dispose();
			...
			cm.gainItem(1332025,60,60,60,60,60,60,60,60,0,0,0,0,0,0,24);//
			cm.gainItem(5220007,-1);
			cm.sendOk("租借成功，有效期24小时!")
      			cm.dispose();
			}
		...
		//	cm.dispose();
			...
			cm.gainItem(1382012,60,60,60,60,60,60,60,60,0,0,0,0,0,0,24);//
			cm.gainItem(5220007,-1);
			cm.sendOk("租借成功，有效期24小时!")
      			cm.dispose();
			}
		...
		//	cm.dispose();
         ...
         cm.gainItem(1452022,60,60,60,60,60,60,60,60,0,0,0,0,0,0,24);//
			cm.gainItem(5220007,-1);
			cm.sendOk("租借成功，有效期24小时!")
			cm.dispose();
			}
		...
		//	cm.dispose();
			...
			cm.gainItem(1462019,60,60,60,60,60,60,60,60,0,0,0,0,0,0,24);//
			cm.gainItem(5220007,-1);
			cm.sendOk("租借成功，有效期24小时!")
      			cm.dispose();
			}
		...
		//	cm.dispose();
			...
			cm.gainItem(1472032,60,60,60,60,60,60,60,60,0,0,0,0,0,0,24);//
			cm.gainItem(5220007,-1);
			cm.sendOk("租借成功，有效期24小时!")
      			cm.dispose();
			}
		...
		//	cm.dispose();
			...
			cm.gainItem(1482041,60,60,60,60,60,60,60,60,0,0,0,0,0,0,24);//
			cm.gainItem(5220007,-1);
			cm.sendOk("租借成功，有效期24小时!")
      			cm.dispose();
			}
		...
		//	cm.dispose();
			...
			cm.gainItem(1492042,60,60,60,60,60,60,60,60,0,0,0,0,0,0,24);//
			cm.gainItem(5220007,-1);
			cm.sendOk("租借成功，有效期24小时!")
      			cm.dispose();
			}
		...
		//	cm.dispose();
			...
			cm.gainItem(1432012,60,60,60,60,60,60,60,60,0,0,0,0,0,0,24);//
			cm.gainItem(5220007,-1);
			cm.sendOk("租借成功，有效期24小时!")
      			cm.dispose();
	       }
		...
		//	cm.dispose();
         ...
         cm.gainItem(1442024,60,60,60,60,60,60,60,60,0,0,0,0,0,0,24);//
			cm.gainItem(5220007,-1);
			cm.sendOk("租借成功，有效期24小时!")
      			cm.dispose();
}       }
