...
var slot = Array();
var no_sj = [1332242, 4000463,1114314];//禁止上架物品
var pass_sj = [1122126,1122122,1122123,1122124,1122125,1112775,1112771,
1112767,
1112763,
1112776,
1112772,
		...
		if (status == 0) {
			...
			if(sel_type == 0){
				...
				if(cm.haveItem(5140005, 1)){
					selStr += "\t#b#L1#上架销售物品#l\t";
					selStr += "\t#b#L5#上架销售装备#l\r\n";
				} else {
					selStr += "\t#b#L0#注册商人服务#l\r\n";
				}
				selStr += "\t#b#L2#下架销售物品#l\t";
				...
				if(sr_type == 0){
					...
					for (var j = 2; j <= 5; j++) {
						for (var i = 0; i < 96; i++) {
							...
							if (cm.getInventory(j).getItem(i).getExpiration() == -1 && MapleItemInformationProvider.getInstance().isDropRestricted(cm.getInventory(j).getItem(i).getItemId()) && !MapleItemInformationProvider.getInstance().isQuestItem(cm.getInventory(j).getItem(i).getItemId())) {
