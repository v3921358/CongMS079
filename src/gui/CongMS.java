...
public class CongMS extends JFrame
{
    ...
    private void initComponents() {
        ...
        this.jTextArea1.setText("感谢使用CongMS服务端版本079\n购买商业端 QQ: 327321366\n------------------------------------------\n更新内容如下\n------------------------------------------\n2021-8-20 CongMS079.1.0更新说明\n1.修复海盗变身碰怪解除变身\n2.添加新BOSS\n3.修复商场封包问题\n\n\n2021-8-13 CongMS079.1.0更新说明\n1.添加自由泡点取消世界泡点\n2.降低BOSS攻击\n\n\n2021-8-11 CongMS079.1.0更新说明\n1.修复远程职业打不死怪\n2.优化源码\n3.修复打不死扎昆\n\n\n2021-8-1 CongMS079.1.0更新说明\n1.修复火毒38问题\n2.修复部分已测试BUG\n3.添加程序窗口\n4.添加重载系统\n5.优化控制台\n\n");
        ...
        this.角色背包.add((Component)this.jTabbedPane5, (Object)new AbsoluteConstraints(0, 0, 870, 640));
    ...
    private void 刷新小青蛇开关() {
        String 小青蛇显示 = "";
        final int 小青蛇 = (int)Integer.valueOf(CongMS.ConfigValuesMap.get((Object)"小青蛇开关"));
        if (小青蛇 <= 0) {
            小青蛇显示 = "小青蛇:开";
        }
        else {
